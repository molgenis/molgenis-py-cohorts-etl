'''
- start with UMCG Cohorts: https://www.umcgresearchdatacatalogue.nl/apps/central/#/
- make new strategy
    - UMCG
        - migration_2-8_to_3-0_catalogue
        - migration_2-8_to_3-0_cohort
            - remove UMCG_ from schema name
    - DataCatalogue
        - migration_2-8_to_3-0_catalogue
    - DataCatalogue Staging
        - migration_2-8_to_3-0_catalogue
        - migration_2-8_to_3-0_network
        - migration_2-8_to_3-0_cohort
    - ConCEPTION, VAC4EU
        - migration_2-8_to_3-0_catalogue
- get catalogue zip with the old model 2.8
- convert to 3.0
    - convert per table
    - store deleted items
- delete catalogue on TARGET if already exists
- create schema on TARGET
- upload converted data to TARGET
'''
