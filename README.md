...
1. Configure the script by setting the environment variables
    ...
    | `MG_TARGET_ONTOLOGY_CREATE`   | create ontology in CatalogueOntologies                      | [[refTable, columns], ..]                                         |
    | ~~`MG_TARGET_ONTOLOGY_READ`~~ | ~~read ontology~~                                           | ~~[[refTable, columns], ..]~~                                     |
    | `MG_TARGET_ONTOLOGY_UPDATE`   | update ontology in Schemas other then CatalogueOntologies   | [[refTable, match: firstColumn, replace: column, with: value] ,..] |
    | `MG_TARGET_ONTOLOGY_DELETE`   | delete ontology in CatalogueOntologies                      | [[refTable, columns], ..]                                                                   |
